    ...
    <div>
      ...
      <div className={styles.header}>
        <img
          ...
          src='images/lookbooks/lookbook2021/lookbook2021_header.jpg'
      ...
      <div className={styles.imageCentered}>
        <AspectRatio ratio={298 / 414} maw={600}>
          <img
            src={'images/lookbooks/lookbook2021/lookbook2021_01.jpg'}
            alt='description'
          />
        </AspectRatio>
      ...
      <div className={styles.imageContainer}>
        <img
          ...
          src={'images/lookbooks/lookbook2021/lookbook2021_02.jpg'}
          alt='description'
        />
      ...
      <div className={styles.imageContainer02}>
        ...
        >
          <img
            ...
            src={'images/lookbooks/lookbook2021/lookbook2021_03.jpg'}
            alt='description'
          />
          <img
            className={styles.imagesGrid}
            src={'images/lookbooks/lookbook2021/lookbook2021_04.jpg'}
            alt='description'
          />
        </SimpleGrid>
      </div>
      <div className={styles.imageContainer}>
        <img
          className={styles.image02}
          src={'images/lookbooks/lookbook2021/lookbook2021_05.jpg'}
          alt='description'
        />
        <div className={styles.productInfo04}>
          <p className={styles.productName}>Reversible Kimono A</p>
