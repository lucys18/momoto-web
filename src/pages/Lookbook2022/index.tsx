    ...
    <div>
      ...
      <div className={styles.header}>
        <img
          ...
          src='images/lookbooks/lookbook2022/lookbook2022_header.jpg'
      ...
      <div className={styles.wrapper}>
        <SimpleGrid cols={{ md: 1, lg: 3 }}>
          <Grid>
            <Grid.Col
              span={{ xs: 8, sm: 8, md: 8, lg: 12 }}
              order={{ xs: 1, sm: 1, md: 1, lg: 1 }}
            >
              <AspectRatio ratio={298 / 414} maw={600}>
                <img
                  src={'images/lookbooks/lookbook2022/lookbook2022_01.jpg'}
                  alt='description'
                />
              </AspectRatio>
            </Grid.Col>
            <Grid.Col
              span={{ xs: 4, sm: 4, md: 4, lg: 12 }}
          ...
          <Grid>
            ...
            >
              <AspectRatio ratio={298 / 414} maw={600}>
                <img
                  src={'images/lookbooks/lookbook2022/lookbook2022_02.jpg'}
                  alt='description'
                />
              </AspectRatio>
            </Grid.Col>
          ...
          <Grid>
            <Grid.Col
              span={{ xs: 8, sm: 8, lg: 12 }}
              order={{ xs: 1, sm: 1, lg: 1 }}
            >
              <AspectRatio ratio={298 / 414} maw={600}>
                <img
                  src={'images/lookbooks/lookbook2022/lookbook2022_03.jpg'}
                  alt='description'
                />
              </AspectRatio>
            </Grid.Col>
            <Grid.Col
              span={{ xs: 4, sm: 4, lg: 12 }}
      ...
      <Grid>
        <Grid.Col span={8}>
          <AspectRatio ratio={298 / 200}>
            <img
              src={'images/lookbooks/lookbook2022/lookbook2022_banner03.jpg'}
              alt='description'
            />
          </AspectRatio>
        </Grid.Col>
        ...
        <SimpleGrid cols={{ md: 1, lg: 3 }}>
          <Grid>
            ...
            >
              <AspectRatio ratio={298 / 414} maw={600}>
                <img
                  src={'images/lookbooks/lookbook2022/lookbook2022_04.jpg'}
                  alt='description'
                />
              </AspectRatio>
            </Grid.Col>
          ...
          <Grid>
            <Grid.Col span={{ xs: 8, sm: 8, md: 8, lg: 12 }} order={1}>
              <AspectRatio ratio={298 / 414} maw={600}>
                <img
                  src={'images/lookbooks/lookbook2022/lookbook2022_05.jpg'}
                  alt='description'
                />
              </AspectRatio>
            </Grid.Col>
          ...
          <Grid>
            ...
            >
              <AspectRatio ratio={298 / 414} maw={600}>
                <img
                  src={'images/lookbooks/lookbook2022/lookbook2022_06.jpg'}
                  alt='description'
                />
              </AspectRatio>
            </Grid.Col>
      ...
      <SimpleGrid cols={{ md: 1, lg: 3 }} spacing={0} verticalSpacing={0}>
        <AspectRatio ratio={298 / 414} maw={800}>
          <img
            src={'images/lookbooks/lookbook2022/lookbook2022_banner02_01.jpg'}
            alt='description'
          />
        </AspectRatio>
        <AspectRatio ratio={298 / 414} maw={800}>
          <img
            src={'images/lookbooks/lookbook2022/lookbook2022_banner02_02.jpg'}
            alt='description'
          />
        </AspectRatio>
        <AspectRatio ratio={298 / 414} maw={800}>
          <img
            src={'images/lookbooks/lookbook2022/lookbook2022_banner02_03.jpg'}
            alt='description'
          />
        </AspectRatio>
      </SimpleGrid>
